...
public class TelaCadastroUsuario extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel lblSubtitulo = new JLabel("Usuario");
        ...
        btnCadastrar = criarBotao("Cadastrar", new Color(40, 167, 69));
    ...
    private void btnCadastrarActionPerformed(ActionEvent evt) {
        ...
        if (usuarioController.salvarUsuario(usuario)) {
            ValidadorCampos.mensagemSucesso("Usuario cadastrado com sucesso!");
            voltarTelaInicial();
        } else {
            ValidadorCampos.mensagemErro("Erro ao cadastrar usuario! Email ja existe.");
        }
    }
